...
def detecting(image_path):
    model_path = os.path.join(
        os.path.dirname(os.path.abspath(__file__)), "traffic_sign_model.keras"
    )
    ...
    top_k_probabilities = predictions[0][top_k_classes]
    top_k_names = [class_mapping_vie[class_index] for class_index in top_k_classes]
